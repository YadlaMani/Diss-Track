...
chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => {
    chrome.storage.local.get("hidden", function(result) { //Function TO GET DATA
        ...
        if(hidden==1){
    if (changeInfo.url) {
      const bannedDomains = ["facebook.com","twitter.com", "instagram.com", "snapchat.com","tiktok.com","netflix.com","primevideo.com","hulu.com","steampowered.com","epicgames.com","amazon.in","flipkart.com","myntra.com","ajio.com","reddit.com","swiggy.com","zomato.com","makemytrip.com","goibibo.com","ajio.com ","nykaa.com","buzzfeed.com","youtube.com"];
